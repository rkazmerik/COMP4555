...
# Score Board
score_value = 0 #create the font for the scoreboard
font = pygame.font.Font("./fonts/Square.ttf", 24) #add a custom font
textX = 10
textY = 10
...
while running:
	...
	show_score(textX, textY) #keep updating the score
