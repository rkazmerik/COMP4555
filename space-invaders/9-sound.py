...
while running:
		...
		if event.type == pygame.KEYDOWN:
			...
			if event.key == pygame.K_SPACE:
				if bullet_state is "ready":
					bullet_sound = pygame.mixer.Sound("./media/laser.wav") #add sound fx for firing a bullet
					bullet_sound.play()
					bulletX = playerX
	...
	for i in range(num_enemies):
		...
		if collision:
			explosion_sound = pygame.mixer.Sound("./media/explosion.wav") #add sound fx for collision
