...
# Bird
bird_surface = pygame.image.load('./assets/bluebird-midflap.png').convert_alpha() #eliminate the black background
...
def rotate_bird(bird): #rotate the bird
...
while True:
  ...
  if game_active: 
    ...
    rotated_bird = rotate_bird(bird_surface) #rotate the bird 
